 ...
 */
final class Version20260505065612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ingredient_shop ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE planning_recipe ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE recipe_ingredient ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE refresh_tokens CHANGE refresh_token refresh_token VARCHAR(128) NOT NULL');
        $this->addSql('ALTER TABLE shopping_list ADD updated_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE shopping_list ADD CONSTRAINT FK_3DC1A4593D865311 FOREIGN KEY (planning_id) REFERENCES planning (id)');
        $this->addSql('ALTER TABLE shopping_list_item ADD created_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ingredient_shop DROP created_at, DROP updated_at');
        ...
        $this->addSql('ALTER TABLE planning_recipe DROP created_at, DROP updated_at');
        $this->addSql('ALTER TABLE recipe DROP created_at, DROP updated_at');
        $this->addSql('ALTER TABLE recipe_ingredient DROP FOREIGN KEY FK_22D1FE1359D8A214');
        $this->addSql('ALTER TABLE recipe_ingredient DROP FOREIGN KEY FK_22D1FE13933FE08C');
        $this->addSql('ALTER TABLE recipe_ingredient DROP created_at, DROP updated_at');
        $this->addSql('ALTER TABLE refresh_tokens CHANGE refresh_token refresh_token VARCHAR(220) NOT NULL');
        ...
        $this->addSql('ALTER TABLE shopping_list_item DROP created_at');
    }
}
