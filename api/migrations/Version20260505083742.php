 ...
 */
final class Version20260505083742 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE shopping_list DROP INDEX IDX_3DC1A4593D865311, ADD UNIQUE INDEX uniq_planning_shopping_list (planning_id)');
        ...
        $this->addSql('CREATE UNIQUE INDEX uniq_shopping_item ON shopping_list_item (shopping_list_id, ingredient_id, unit)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE shopping_list DROP INDEX uniq_planning_shopping_list, ADD INDEX IDX_3DC1A4593D865311 (planning_id)');
        ...
        $this->addSql('DROP INDEX uniq_shopping_item ON shopping_list_item');
    }
}
