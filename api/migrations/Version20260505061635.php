 ...
 */
final class Version20260505061635 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE shopping_list ADD name VARCHAR(255) DEFAULT NULL, ADD budget DOUBLE PRECISION DEFAULT NULL, DROP user_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE shopping_list ADD user_id INT NOT NULL, DROP name, DROP budget');
