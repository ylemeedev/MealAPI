 ...
 */
final class Version20260504203650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE planning_recipe ADD meal_type VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE recipe DROP course_type');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE planning_recipe DROP meal_type');
        $this->addSql('ALTER TABLE recipe ADD course_type VARCHAR(255) NOT NULL');
